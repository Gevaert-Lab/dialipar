...
The workflow (Fig ) include the following steps:
...
`comparisons` should include all contrasts to be tested in the analysis. Each comparison must be formatted as `variable + value` foe example  "TreatmentA - TreatmentB".  
